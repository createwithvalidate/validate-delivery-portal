const seedData = {
  mode: "admin",
  session: null,
  selectedClientId: "silver-dollar-city",
  selectedProjectId: "summer-campaign",
  selectedVideoId: "launch-film",
  clients: [
    {
      ...
      summary: "Theme park campaigns, seasonal spots, and social cutdowns.",
      archived: false,
    },
    {
      id: "big-cedar-lodge",
      ...
      summary: "Resort brand films, outdoor lifestyle edits, and launch assets.",
      archived: false,
    },
    {
      id: "herschend-family-entertainment",
      name: "Herschend Family Entertainment",
      contact: "Nora James",
      email: "nora.james@example.com",
      summary: "Corporate storytelling, recruitment films, and internal reviews.",
      archived: false,
    },
    {
      id: "taneycomo-outfitters",
      name: "Taneycomo Outfitters",
      contact: "Caleb Brooks",
      email: "caleb.brooks@example.com",
      summary: "Fishing, lake lifestyle, and product-focused video projects.",
      archived: false,
    },
  ],
  projects: [
    {
      id: "summer-campaign",
      clientId: "silver-dollar-city",
      name: "Summer Campaign",
      status: "review",
      description: "Main park spot, social cutdowns, and final delivery review.",
      archived: false,
    },
    {
      id: "christmas-preview",
      clientId: "silver-dollar-city",
      name: "Christmas Preview",
      status: "approved",
      description: "Teaser film and paid social edit for seasonal launch.",
      archived: false,
    },
    {
      id: "lodge-brand-film",
      clientId: "big-cedar-lodge",
    ...
    {
      id: "recruitment-story",
      clientId: "herschend-family-entertainment",
    ...
    {
      id: "spring-fishing-launch",
      clientId: "taneycomo-outfitters",
  ...
  videos: [
    ...
    {
      id: "christmas-teaser",
      projectId: "christmas-preview",
      title: "Christmas Teaser",
      status: "approved",
      due: "July 2",
    },
    {
      id: "cedar-hero-film",
      projectId: "lodge-brand-film",
      title: "Hero Film",
      status: "review",
      due: "June 28",
    },
    ...
    {
      id: "rod-launch",
      projectId: "spring-fishing-launch",
      title: "Rod Launch",
      status: "draft",
      due: "July 12",
    },
  ...
  versions: [
    ...
    {
      id: "version-launch-v1",
      videoId: "launch-film",
      label: "Version 1",
      provider: "Bunny Stream",
      embedUrl: "",
      bunnyVideoId: "",
      note: "First review cut with temporary music.",
      createdAt: "3 days ago",
      approved: false,
    },
    {
      id: "version-social-v1",
      videoId: "social-cutdown",
      label: "Version 1",
      provider: "Bunny Stream",
      embedUrl: "",
      bunnyVideoId: "",
      note: "Vertical cut for paid social placement.",
      createdAt: "Today",
      approved: false,
    },
    {
      id: "version-christmas-v3",
      videoId: "christmas-teaser",
      label: "Final",
      provider: "Bunny Stream",
      embedUrl: "",
      bunnyVideoId: "",
      note: "Approved final teaser with locked graphics.",
      createdAt: "Last week",
      approved: true,
    },
    {
      id: "version-cedar-v1",
      videoId: "cedar-hero-film",
      label: "Version 1",
      provider: "Bunny Stream",
      embedUrl: "",
      bunnyVideoId: "",
  ...
  comments: [
    ...
    },
    {
      ...
      author: "Validate",
      role: "admin",
      body: "Yes, we can extend that shot and rebalance the music underneath it.",
      createdAt: "Just now",
    },
    {
      id: "comment-cedar-1",
      versionId: "version-cedar-v1",
  ...
  activity: [
    "Sent Version 2 for Launch Film to megan.carter@example.com",
    "Megan Carter commented on Launch Film",
    "Final for Christmas Teaser was approved",
    "Uploaded Version 1 for Hero Film",
  ],
};

const storeKey = "validate-delivery-portal-demo-v4";
